...
const LoginSeller = () => {
  ...
  const handleOnSubmit = (e) => {
    ...
    const phoneNumber = sellerInfo?.phoneNumber;
    ...
    if (!isValidPakistaniNumber(phoneNumber)) {
      toast.error("Phone number must start with 03 or +92 and contain 11 digits.");
      return;
    }

    if (email === localStorageEmail && password === localStoragePassword) {
      toast.success("Login success");
      navigate(`/shop/${localStorage.getItem("seller_id")}`);
    } else {
          ...
          <form className="space-y-6" onSubmit={handleOnSubmit}>
            ...
            <div className={`${styles.noramlFlex} justify-between`}>
              ...
              <div className="text-sm">
                <Link to="/seller/forget-password" className="font-medium text-blue-600 hover:text-blue-500">
